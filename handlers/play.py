...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    draw.text(
        (190, 670),
        f"Powered By: 👑MAHABALI (@MAHABALIX)",
        (255, 255, 255),
        font=font,
    )
    img.save("final.png")
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/6a4120d98537064753895.jpg"
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/6a4120d98537064753895.jpg", 
                             caption="**MAHABALI MUSIC BEAST\ NOW PLAING...**"
    )
...
async def skip(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/6a4120d98537064753895.jpg", 
                             caption=f'**MAHABALI MUSIC BEAST\n SONG SKKIPED ...**'
   ) 
...
async def stop(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/6a4120d98537064753895.jpg", 
                             caption="**MAHABALI MUSIC BEAST\ SONG TERMINATED ...**"
    )
